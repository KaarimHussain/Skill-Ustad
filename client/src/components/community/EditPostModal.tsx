...
export default function EditPostModal({ 
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await CommunityService.updatePost(post.id!, updateData, userId);
            
            NotificationService.success('Success', 'Post updated successfully!');
            onClose();
            onPostUpdated();
        } catch (error) {
            console.error('Error updating post:', error);
            NotificationService.error('Error', 'Failed to update post. Please try again.');
        } finally {
            setIsLoading(false);
        }
    };
