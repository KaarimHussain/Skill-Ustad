...
import { Briefcase, MapPin, DollarSign, Mail, Users, AlertCircle, X, ArrowBigLeft } from "lucide-react"
import { Link, useNavigate } from "react-router-dom"
import JobService, { type PostJobRequest } from "@/services/job.service"
import { toast } from "sonner"

export default function CompanyCreateJobs() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setSubmitError(error.message || "Failed to create job listing. Please try again.")
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-8 flex flex-col items-center justify-center gap-2">
                    ...
                    <div>
                        ...
                        <h1 className="text-4xl font-bold text-gray-900 mb-2">Create Job Listing</h1>
