...
export default function RoadmapProcessing() {
    ...
    const generateAndSaveRoadmap = async (sessionKey: string) => {
        ...
        try {
            ...
            const difficultyRes = await RoadmapService.getRoadmapDifficulty("Generate a difficulty based on the data in one word", filledNodes);

            if (difficultyRes.toLowerCase() != "easy" || difficultyRes.toLowerCase() != "medium" || difficultyRes.toLowerCase() != "hard") {
