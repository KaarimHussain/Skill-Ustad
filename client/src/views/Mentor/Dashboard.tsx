...
const contentToolLinks = [
    {
        ...
        description: "Upload materials or link AI-generated resources for mentees.",
        icon: BookOpen,
    ...
    },
    {
        ...
        description: "Set availability and let mentees book 1-on-1 or group calls.",
        icon: Calendar,
    ...
    },
    {
        ...
        description: "Answer questions live or via chat with structured Q&A tools.",
        icon: MessageCircle,
    ...
    {
        title: "AI Lesson Suggestions",
        description: "Get AI-powered recommendations for mentee lessons based on weak areas.",
        icon: Lightbulb,
